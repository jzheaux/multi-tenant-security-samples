package sample.issuers.webflux.user;
...
class MongoUserInitiailizer implements SmartInitializingSingleton {
	...
	public void afterSingletonsInstantiated() {
		...
		this.users.save(new User(4L, "filip@example.com", passsword, "Filip", "Hanik")).block();
		this.users.save(new User(5L, "ria@example.com", passsword, "Ria", "Stein")).block();
	}
}
